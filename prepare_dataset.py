...
if __name__ == "__main__":
    ...
    parser.add_argument('--video_dir', type=str,
                        default='/home/YueChang/phd_ws/dl5011/dataset/20bn-something-something-v2',
                        help='视频文件目录')
    parser.add_argument('--labels_path', type=str,
                        default='/home/YueChang/phd_ws/dl5011/dataset/labels/labels.json',
                        help='标签映射文件')
    parser.add_argument('--train_anno', type=str,
                        default='/home/YueChang/phd_ws/dl5011/dataset/labels/train.json',
                        help='训练集标注文件')
    parser.add_argument('--val_anno', type=str,
                        default='/home/YueChang/phd_ws/dl5011/dataset/labels/validation.json',
                        help='验证集标注文件')
    parser.add_argument('--output_dir', type=str,
                        default='/home/YueChang/phd_ws/dl5011/processed_data',
                        help='输出目录')
