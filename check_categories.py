...
# 加载训练和验证集
train_annos = load_annotations('/home/YueChang/phd_ws/dl5011/dataset/labels/train.json')
val_annos = load_annotations('/home/YueChang/phd_ws/dl5011/dataset/labels/validation.json')
